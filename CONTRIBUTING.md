...
This file describes the process for contributing to `the-repo-name`.

## Starting

First and foremost, [fork](https://github.com/sedaprotocol/the-repo-name/fork) the repository. Then please read the
...
1. Firstly, please open a
   [PR](https://github.com/SedaProtocol/the-repo-name/compare) from your forked repo
   to the `main` branch of `the-repo-name`.
